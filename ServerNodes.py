...
vfd_ConnectionStatus =  node.add_variable("ns=2;s=vfd_ConnectionStatus", "Vfd_ConnectionStatus", 0) 
vfd_RunMode =  node.add_variable("ns=2;s=vfd_RunMode", "Vfd_RunMode", 0) 
...
vfd_Power =  node.add_variable("ns=2;s=vfd_Power", "Vfd_Power", 0) 
conveyorAxis =  node.add_variable("ns=2;s=conveyorAxis", "ConveyorAxis", 0) 
# Entry Sensor tags
ent_IO_Communication = node.add_variable("ns=2;s=ent_IO_Communication", "Ent_IO_Communication", 0)
...
ent_PowerSupply = node.add_variable("ns=2;s=ent_PowerSupply", "Ent_PowerSupply", 0)
ent_DigitalOutput = node.add_variable("ns=2;s=ent_DigitalOutput", "Ent_DigitalOutput", 0)
...
int_IO_Communication = node.add_variable("ns=2;s=int_IO_Communication", "Int_IO_Communication", 0)
...
int_PowerSupply = node.add_variable("ns=2;s=int_PowerSupply", "Int_PowerSupply", 0)
int_DigitalOutput = node.add_variable("ns=2;s=int_DigitalOutput", "Int_DigitalOutput", 0)
...
# Station Mode Tag
auto = node.add_variable("ns=2;s=auto", "Auto", 0)
manual = node.add_variable("ns=2;s=manual", "Manual", 0)
# Order Tag
executeOrder = node.add_variable("ns=2;s=executeOrder", "ExecuteOrder", 0)
